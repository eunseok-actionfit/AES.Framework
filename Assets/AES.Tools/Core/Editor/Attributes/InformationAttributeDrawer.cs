...
namespace AES.Tools.Editor
{
    ...
    public class InformationAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect rect, SerializedProperty prop, GUIContent label)
        {
            ...
            else { EditorGUI.PropertyField(rect, prop, label, true); }
        }
		#endif
        ...
        {
            if (MenuHelp.HelpEnabled) { return EditorGUI.GetPropertyHeight(property) + DetermineTextboxHeight(informationAttribute.Message) + spaceAfterTheTextBox + spaceBeforeTheTextBox; }
