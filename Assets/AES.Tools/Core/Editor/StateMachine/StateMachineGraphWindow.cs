...
namespace AES.Tools.Editor
{
    public sealed class StateMachineGraphWindow : EditorWindow
    {
        ...
        StateMachine.Core.StateMachine _machine;

        readonly List<StateMachine.Core.StateMachine.StateInfo> _stateInfos = new();
        readonly List<StateMachine.Core.StateMachine.TransitionInfo> _transInfos = new();
        ...
        Dictionary<string, int> ComputeDepthByBfs(
            List<StateMachine.Core.StateMachine.StateInfo> states,
