...
namespace AES.Tools.VContainer
{
    ...
    public class AdsService : IAdsService
    {
        ...
        // ✅ ctor 변경: AdsRuntimeConfig 제거
        public AdsService(ITimerScheduler scheduler, AdsRuntimeSettings settings, TestDeviceFlags testDeviceFlags)
        {
        ...
        private IAppOpenAdService CreateAppOpenService(AdsProfile cfg)
        {
            ...
            {
                case AdNetworkType.AdMob: return new AdmobAppOpenService(cfg.appOpen.adUnitId);
                case AdNetworkType.AppLovinMax: return new MaxAppOpenService(cfg.appOpen.adUnitId);
                default: return null;
            }
        }
        ...
        private IInterstitialAdService CreateInterstitialService(AdsProfile cfg)
        {
            ...
            {
                case AdNetworkType.AdMob: return new AdmobInterstitialService(cfg.interstitial.adUnitId);
                case AdNetworkType.AppLovinMax: return new MaxInterstitialService(cfg.interstitial.adUnitId, _scheduler);
                default: return null;
            }
        }
        ...
        private IRewardedAdService CreateRewardedService(AdsProfile cfg)
        {
            ...
            {
                case AdNetworkType.AdMob: return new AdmobRewardedService(cfg.rewarded.adUnitId);
                case AdNetworkType.AppLovinMax: return new MaxRewardedService(cfg.rewarded.adUnitId, _scheduler);
                default: return null;
            }
        }
        ...
        private IBannerAdService CreateBannerService(AdsProfile cfg)
        {
            ...
            {
                case AdNetworkType.AdMob: return new AdmobBannerService(cfg.banner.adUnitId);
                case AdNetworkType.AppLovinMax: return new MaxBannerService(cfg.banner.adUnitId);
                default: return null;
            }
        }
